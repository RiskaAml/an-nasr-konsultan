...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CV. AN NASR KONSULTAN — Konsultan Teknik Sipil Jombang" },
      {
        name: "description",
        content:
          "Jasa perencanaan, pengawasan, perizinan, dan konstruksi di Kabupaten Jombang, Jawa Timur.",
      },
      { name: "author", content: "CV. AN NASR KONSULTAN" },
      { property: "og:site_name", content: "CV. AN NASR KONSULTAN" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description:
            "Jasa konsultansi teknik sipil, perencanaan, pengawasan, perizinan, dan konstruksi di Kabupaten Jombang, Jawa Timur.",
          areaServed: "Kabupaten Jombang, Jawa Timur",
          address: {
            "@type": "PostalAddress",
